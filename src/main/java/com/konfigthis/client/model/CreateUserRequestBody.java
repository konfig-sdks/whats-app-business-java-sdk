...
public class CreateUserRequestBody {
  ...
  **/
  ...
  @ApiModelProperty(example = "password", required = true, value = "username")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "username", required = true, value = "password")
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateUserRequestBody
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateUserRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
