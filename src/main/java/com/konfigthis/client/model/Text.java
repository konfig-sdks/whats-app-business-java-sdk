...
public class Text {
  ...
  **/
  ...
  @ApiModelProperty(example = "your-text-message-content", required = true, value = "")
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Text.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
