...
public class WebhookSystem {
  ...
  **/
  ...
  @ApiModelProperty(example = "+1 (650) 387-5246 added +1 (650) 644-8470", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "GROUP_USER_JOINED", value = "")
   ...
   * @return the WebhookSystem instance itself
   */
  public WebhookSystem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.body, webhookSystem.body) &&
        ...
        Objects.equals(this.additionalProperties, webhookSystem.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(body, type, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookSystem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookSystem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookSystem>() {
           ...
           public WebhookSystem read(JsonReader in) throws IOException {
             ...
             WebhookSystem instance = thisAdapter.fromJsonTree(jsonObj);
