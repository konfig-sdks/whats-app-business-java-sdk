...
public class UpdateUserRequestBody {
  ...
  **/
  ...
  @ApiModelProperty(example = "New Password", required = true, value = "password")
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateUserRequestBody
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateUserRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
