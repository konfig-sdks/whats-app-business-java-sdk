...
public class WebhookVoice {
  ...
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(example = "/usr/local/wamedia/shared/463e/b7ec/ff4e4d9bb1101879cbd411b2", value = "Absolute filename and location on media volume. This parameter is deprecated.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "463eb7ec-ff4e-4d9b-b110-1879cbd411b2", value = "ID of the media. Can be used to delete the media if stored locally on the client.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "audio/ogg; codecs=opus", value = "Mime type of media")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "fa9e1807d936b7cebe63654ea3a7912b1fa9479220258d823590521ef53b0710", value = "Checksum")
   ...
   * @return the WebhookVoice instance itself
   */
  public WebhookVoice putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.caption, webhookVoice.caption) &&
        ...
        Objects.equals(this.additionalProperties, webhookVoice.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookVoice
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookVoice.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookVoice>() {
           ...
           public WebhookVoice read(JsonReader in) throws IOException {
             ...
             WebhookVoice instance = thisAdapter.fromJsonTree(jsonObj);
