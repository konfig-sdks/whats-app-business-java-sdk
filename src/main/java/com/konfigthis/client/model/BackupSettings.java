...
public class BackupSettings {
  ...
  **/
  ...
  @ApiModelProperty(example = "encrypted-backup-data", value = "The data that has been backed up, encrypted for security.")
   ...
   * @return the BackupSettings instance itself
   */
  public BackupSettings putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, backupSettings.data)&&
        Objects.equals(this.additionalProperties, backupSettings.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BackupSettings
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BackupSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BackupSettings>() {
           ...
           public BackupSettings read(JsonReader in) throws IOException {
             ...
             BackupSettings instance = thisAdapter.fromJsonTree(jsonObj);
