...
public class CheckContactRequestBody {
  ...
  **/
  ...
  @ApiModelProperty(example = "NO_WAIT", value = "Blocking determines whether the request should wait for the processing to complete (synchronous) or not (asynchronous).")
  ...
  **/
   ...
   * @return the CheckContactRequestBody instance itself
   */
  public CheckContactRequestBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.blocking, checkContactRequestBody.blocking) &&
        ...
        Objects.equals(this.additionalProperties, checkContactRequestBody.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(blocking, contacts, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CheckContactRequestBody
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CheckContactRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CheckContactRequestBody>() {
           ...
           public CheckContactRequestBody read(JsonReader in) throws IOException {
             ...
             CheckContactRequestBody instance = thisAdapter.fromJsonTree(jsonObj);
