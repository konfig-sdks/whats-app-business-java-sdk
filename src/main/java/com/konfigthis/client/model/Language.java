...
public class Language {
  ...
  **/
  ...
  @ApiModelProperty(example = "en", required = true, value = "The code of the language or locale to use — Accepts both language and language_locale formats (e.g., en and en_US).")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "DETERMINISTIC", required = true, value = "The language policy the message should follow")
