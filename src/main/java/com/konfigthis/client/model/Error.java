...
public class Error {
  ...
  **/
  ...
  @ApiModelProperty(example = "error-code-title", value = "error title")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1234", value = "See the https://developers.facebook.com/docs/whatsapp/api/errors for more information.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "optional-detailed-error-message", value = "error detail")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "location for error detail")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, code, details, href, additionalProperties);
  }
